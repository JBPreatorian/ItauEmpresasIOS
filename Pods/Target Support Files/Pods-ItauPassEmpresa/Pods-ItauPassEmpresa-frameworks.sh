...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/SDKCore/SDKiOSCore.framework"
  install_framework "${PODS_ROOT}/SDKiOSRoutes/SDKiOSRoutes.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SMXMLDocument/SMXMLDocument.framework"
